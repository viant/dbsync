...
- partition.providerSQL: SQL providng partition values
- columns: partition column or pseudo columns
- threads: number of threads pocessing partition sync


_Example of Vertica to BigQuery partition based sync._
